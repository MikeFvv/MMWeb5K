...
- (instancetype)init
{
    ...
    if (self) {
        self.frame = CGRectMake(0, 0, kViewWidth, kViewHeight-kUINavHeight);
...
- (void)show
{
    ...
    if (_animate) {
        CGPoint fromPoint = CGPointMake(kViewWidth/2, (kViewHeight-kUINavHeight)+kBaseViewHeight/2);
        CGPoint toPoint   = CGPointMake(kViewWidth/2, (kViewHeight-kUINavHeight)-kBaseViewHeight/2);
