...
@implementation DiscountCarHeadCell
...
+(instancetype)cellWithTableView:(UITableView *)tableView {
    ...
    static NSString *ID = @"DiscountCarHeadCell";
    DiscountCarHeadCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[DiscountCarHeadCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
