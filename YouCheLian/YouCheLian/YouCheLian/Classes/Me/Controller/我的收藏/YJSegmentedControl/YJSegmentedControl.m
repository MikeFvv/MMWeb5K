...
/// @param titleDataSouece <#titleDataSouece description#>
/// @param backgroundColor <#backgroundColor description#>
/// @param titleColor      <#titleColor description#>
/// @param titleFont       <#titleFont description#>
/// @param selectColor     <#selectColor description#>
/// @param buttonDownColor <#buttonDownColor description#>
...
- (void)AddSegumentArray:(NSArray *)SegumentArray{
    ...
    for (int i = 0; i < SegumentArray.count; i++) {
        ...
        UIButton * btn = [[UIButton alloc] initWithFrame:CGRectMake(i * witdthFloat, 0, witdthFloat, self.bounds.size.height - 3)];
        ...
        if (i == 0) {
            buttonDownView =[[UIView alloc]initWithFrame:CGRectMake(i * witdthFloat, self.bounds.size.height - 3, witdthFloat, 3)];
            
//            buttonDownView =[[UIView alloc]initWithFrame:CGRectMake(i * witdthFloat, 0, witdthFloat, self.bounds.size.height)];
...
-(void)selectTheSegument:(NSInteger)segument{
    ...
    if (selectSeugment != segument) {
        ...
        [UIView animateWithDuration:0.2 animations:^{
            ...
            [buttonDownView setFrame:CGRectMake(segument * witdthFloat,self.bounds.size.height - 3, witdthFloat, 3)];
            
//            [buttonDownView setFrame:CGRectMake(segument * witdthFloat,0, witdthFloat, self.bounds.size.height)];
        }];
