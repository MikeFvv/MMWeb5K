...
// 获取屏幕宽度与高度
#define kUIScreenWidthMM       [UIScreen mainScreen].bounds.size.width
#define kUIScreenHeightMM      [UIScreen mainScreen].bounds.size.height
// 适配屏幕比例 iPhone6
#define kMMUIScreenWidth_Scale_iPhone6(_X_) (_X_ * (kUIScreenWidthMM/375))
// 适配屏幕比例 iPhone6
#define kMMUIScreenHeight_Scale_iPhone6(_X_) (_X_ * (kUIScreenHeightMM/667))

#define AlertWidth kMMUIScreenWidth_Scale_iPhone6(300)
#define AlertHeight kMMUIScreenHeight_Scale_iPhone6(300)
...
- (void)webViewDidStartLoad:(UIWebView *)webView {
  ...
  //    _progressLayer = [WYWebProgressLayer layerWithFrame:CGRectMake(0, 64, MMSCREEN_WIDTH, 2)];
  _progressLayer = [WYWebProgressLayer layerWithFrame:CGRectMake(0, 0, MMSCREEN_WIDTH, 2)];
